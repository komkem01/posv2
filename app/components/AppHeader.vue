      ...
      <nav class="flex items-center gap-6">
        ...
        <template v-if="auth.isLoggedIn">
          ...
          <div class="flex items-center bg-slate-100 p-1 rounded-xl border border-slate-200/60 shadow-inner">
            ...
            <NuxtLink 
              to="/pos" 
              class="relative px-4 py-1.5 rounded-lg text-xs font-bold transition-all duration-200 flex items-center gap-1.5"
              :class="$route.path.startsWith('/pos') 
                ? 'bg-white text-blue-600 shadow-sm border border-slate-200/40 after:absolute after:left-2 after:right-2 after:-bottom-1 after:h-0.5 after:rounded-full after:bg-blue-500' 
            ...
            <NuxtLink 
              to="/admin" 
              class="relative px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all duration-200 flex items-center gap-1.5"
